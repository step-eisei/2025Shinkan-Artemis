...
def get_object_theta_and_proportion(img=None):
    # CSV ファイルから閾値を読み込む
    lower_thresholds, upper_thresholds = read_hsv_thresholds('/home/pi/TANE2025/prep/HSV_slider_values.csv')
    lower_bound = np.array([lower_thresholds['Hue'], lower_thresholds['Saturation'], lower_thresholds['Value']])
    upper_bound = np.array([upper_thresholds['Hue'], upper_thresholds['Saturation'], upper_thresholds['Value']])
